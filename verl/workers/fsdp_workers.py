...
class FSDPWorker(Worker):
    ...
    def _process_multi_modal_inputs(self, data: DataProto):
        ...
        if "multi_modal_inputs" not in self._cache:
            ...
            max_frames = data.meta_info["max_frames"]
                ...
                if index not in multi_modal_inputs_cache:
                    ...
                    if "videos" in multi_modal_data:
                        for video in multi_modal_data["videos"]:
                            videos.append(
                                process_video(video, min_pixels, max_pixels, video_fps, max_frames, return_metadata=True)
                            )
                    ...
                    if len(images) != 0:
                        ...
                        video_tensors = [v[0] for v in videos]
                        video_metadata = [v[1] for v in videos]
