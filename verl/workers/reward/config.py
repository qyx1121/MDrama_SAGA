...
class RewardConfig:
    ...
    llm_judge_ip: Optional[str] = field(default=None, init=False)
    llm_judge_port: Optional[str] = field(default=None, init=False)

    graph_ip: Optional[str] = field(default=None, init=False)
    graph_port: Optional[str] = field(default=None, init=False)

    embedding_ip: Optional[str] = field(default=None, init=False)
    embedding_port: Optional[str] = field(default=None, init=False)

    caption_reward_type: Optional[list] = field(default_factory=list)
